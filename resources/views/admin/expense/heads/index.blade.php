...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Expense Heads List (Total: {{!empty($records) ? $records->total() : 0}})</h1>
                </div>
                <div class="col-sm-6">
                    <div class="add-new float-sm-right">
                        <a href="{{url('admin/expenses/heads/create')}}" class="btn btn-primary">Add New</a>
                    </div>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                            ...
                            <form action="">
                                <div class="form-group row">
                                    <div class="col-2">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{Request::get('name')}}" placeholder="Enter expense head name">
                                    </div>
                                    <div class="col-2">
                                    ...
                                    <div class="col-2" style="margin-top: 32px;">
                                        ...
                                        <a href="{{url('admin/expenses/heads/list')}}" class="btn btn-success">Clear All</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Expense heads list</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body p-0">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('admin/expenses/heads/edit/'.$record->id)}}" class="btn btn-primary">Edit</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @else
