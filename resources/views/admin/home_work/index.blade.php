                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="min-width: 200px;">
                                            <a href="{{url('admin/home-work/edit/'.$record->id)}}" class="btn btn-primary">Edit</a>
                                            <a href="{{url('admin/home-work/delete/'.$record->id)}}" class="btn btn-danger">Delete</a>
                                            <a href="{{url('admin/home-work/submitted/'.$record->id)}}" class="btn btn-success">View Submitted</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @else
