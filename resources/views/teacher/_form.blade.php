<div class="card-body">
    ...
    <div class="row">
        <div class="form-group col-4">
            ...
            <input type="date" value="{{ old('admission_date') ?? (isset($record) ? $record->admission_date : '') }}" disabled class="form-control" id="InputAdmissionDate" placeholder="Enter admission date" required>
    ...
    <div class="row">
        ...
        <div class="form-group col-4">
            ...
            <input type="text" value="{{ old('note') ?? (isset($record) ? $record->note : '') }}" disabled class="form-control" id="InputNote" placeholder="Enter note" required>
