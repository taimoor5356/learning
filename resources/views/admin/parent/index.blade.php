                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$record->email}}</td>
                                        <td class="text-capitalize">{{$record->student_detail?->admission_number}}</td>
                                        <td class="text-capitalize">{{$record->student_detail?->roll_number}}</td>
                                        <td class="text-capitalize">{{$record->student_detail?->class?->name}}</td>
                                        ...
                                        <td>{{$record->student_detail?->admission_date}}</td>
