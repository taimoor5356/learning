<div class="card-body">
    <div class="row">
        ...
        <div class="form-group col-4">
            ...
            <input type="text" value="{{ old('admission_number') ?? (isset($record->student_detail) ? $record->student_detail->admission_number : '') }}" name="admission_number" class="form-control" id="InputAdmissionNumber" placeholder="Enter admission number" required>
        ...
        <div class="form-group col-4">
            ...
            <input type="text" value="{{ old('roll_number') ?? (isset($record->student_detail) ? $record->student_detail->roll_number : '') }}" name="roll_number" class="form-control" id="InputRollNo" placeholder="Enter roll number" required>
        ...
        <div class="form-group col-4">
            ...
            <select name="class_id" class="form-control" id="InputClass" required>
                ...
                @foreach($classes as $key => $class)
                    <option value="{{$class->id}}" {{ isset($record->student_detail) ? ($class->id == $record->student_detail->class_id ? 'selected' : '') : (old('class_id') == $class->id ? 'selected' : '') }}>{{$class->name}}</option>
                @endforeach
            </select>
    ...
    <div class="row">
        <div class="form-group col-4">
            ...
            <input type="date" value="{{ old('admission_date') ?? (isset($record->student_detail) ? $record->student_detail->admission_date : '') }}" name="admission_date" class="form-control" id="InputAdmissionDate" required>
        ...
        <div class="form-group col-4">
            ...
            <div class="row mt-2">
                <div class="col-12">
                    <img src="@isset($record){{$record->getProfilePic()}}@else{{url('public/images/profile/avatar.png')}}@endisset" class="border rounded" width="100px" height="100px" alt="">
                </div>
            </div>
        </div>
        <div class="form-group col-4">
