                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add Teacher Review</h3>
                        </div>
                        <!-- form start -->
                        <form role="form" id="form" method="POST" action="{{url('teacher-review/store')}}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label for="InputTeacherId">Teacher Name *</label>
                                        <select name="user_id" class="form-control" id="InputTeacherId">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="subject_name" id="InputSubjectName" class="form-control" placeholder="Enter subject name">
                                    </div>
                                    <div class="form-group col-12">
                                        <label for="InputTeacherComment">Comment *</label>
                                        <textarea name="comment" class="form-control" id="InputTeacherComment" placeholder="Enter your comment"></textarea>
                                    </div>
                                    <div class="form-group col-12 star-rating">
                                        <label for="InputTeacherRating">Rating *</label>
                                        <br>
                                        ...
                                        <br>
                                        <br>
                                        <input type="hidden" id="teacher-rating-value" name="teacher_rating">
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.ratingstar').on('click', function() {
            ...
            highlightStars(selectedRating);
            $('#teacher-rating-value').val(selectedRating);
        });
