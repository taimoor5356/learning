<div class="card-body">
    <div class="row">
        ...
        <div class="form-group col-4">
            ...
            <input type="text" value="{{ old('admission_number') ?? (isset($record) ? $record->admission_number : '') }}" name="admission_number" class="form-control" id="InputAdmissionNumber" placeholder="Enter admission number" required>
        ...
        <div class="form-group col-4">
            ...
            <input type="text" value="{{ old('roll_number') ?? (isset($record) ? $record->roll_number : '') }}" name="roll_number" class="form-control" id="InputRollNo" placeholder="Enter roll number" required>
